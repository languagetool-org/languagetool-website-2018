...
<head>
    ...
    <meta property="og:image" content="https://languagetool.org/images/lt_logo.png">
    ...
    <link href="{{ asset('css/style.css') }}?20200117" rel="stylesheet">
    ...
    <script src="{{ asset('vendors/tiny_mce/plugins/atd-tinymce/editor_plugin3.js?20200825') }}"></script>
