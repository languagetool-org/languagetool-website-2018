    ...
    <div id="textContent" class="content-section" style="text-align: left">
        ...
        <div class="container">
            ...
            <ul>
                ...
                <li>Добавлены новые слова для орфографической проверки в приложении для рабочего стола.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Улучшена работа сервера LT в приложении для рабочего стола и консольной версии, внесены изменения в настройки сервера по умолчанию.</li>
            ...
            <ul>
                ...
                <li>Добавлены новые слова для орфографической проверки в приложение.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Увеличена скорость проверки текста в приложении и консольной версии программы.</li>
            ...
            <ul>
                ...
                <li>Обновлён интерфейс версии для рабочего стола.</li>
                <li>Полный <a href="http://languagetool.org/download/CHANGES.md">список изменений</a>.</li>
                Изменения для русскоязычного модуля включают:
                <li>Улучшен и существенно дополнен словарь для проверки орфографии (в приложении для рабочего стола).</li>
            ...
            <ul>
                ...
                <li>Обновлён словарь для проверки орфографии (в приложении для рабочего стола).</li>

                Остальные изменения:
                <li>В программу включён новый словарь немецкого языка для проверки орфографии (в приложении для рабочего стола).</li>
            ...
            <ul>
                ...
                <li>В программу включён новый словарь белорусского языка для проверки орфографии (в приложении для рабочего стола).</li>
            ...
            <ul>
                ...
                <li>Теперь для автоопределения языка при проверке текстов в приложении для рабочего стола и в консольной версии используется language-detector.</li>
            ...
            <ul>
                ...
                <li>В приложении для рабочего стола словарь для проверки орфографии существенно расширен на основе словарей пользователей программы.
                <li>Добавлены новые правила.</li>
                <li>Переработаны старые правила для улучшения качества проверки.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Переработаны старые правила для улучшения качества проверки.</li>
                <li>Для приложения рабочего стола в словарь проверки орфографии внесена дополнительная информация (частотность употребления слов), которая используется при формировании вариантов исправлений орфографических ошибок.</li>
            </ul>
            <p>Остальные изменения:</p>
            <ul>
            ...
            <ul>
                <li>Версия выпущена только в виде приложения для рабочего стола и в виде консольной версии.</li>
            ...
            <ul>
                ...
                <li>В LibreOffice 3.5 для некоторых правил теперь доступно онлайн описание ошибок.</li>
                <li>Добавлено правило по поиску повторов слов в предложении (отключено в начальных настройках по умолчанию).</li>
            </ul>
            <p>Остальные изменения:</p>
            <ul>
