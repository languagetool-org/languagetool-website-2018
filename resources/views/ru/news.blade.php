    ...
    <div id="textContent" class="content-section" style="text-align: left">
        ...
        <div class="container">
            ...
            <ul>
                ...
                <li>В независимой версии обновлены библиотеки hunspell до версии 1.7. Эти библиотеки существуют только в 64-битном варианте. Новые библиотеки используются только для немецкого и французского языков.</li>
            </ul>
