    ...
    <div id="textContent" class="content-section" style="text-align: left">
        ...
        <div class="container">
            ...
            <p>Это расширение не работает с очень небольшим числом сайтов. Одним из таких сайтов является
                Google Docs, для которого создано <a href="https://chrome.google.com/webstore/detail/languagetool/kjcoklfhicmkbfifghaecedbohbmofkm">специальное расширение LT для Google Docs</a>. Если найдётся другой такой сайт, <a href="../../support/">дайте нам знать</a>.
