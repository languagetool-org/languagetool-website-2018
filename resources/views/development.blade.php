    ...
    <div id="textContent" class="content-section" style="text-align: left">
        <div class="container">
            ...
            <ul>
                ...
                <li><a href="http://wiki.languagetool.org/java-api">Using LanguageTool from a Java application</a> (<a href="/dev/api/index.html?org/languagetool/JLanguageTool.html">Javadoc API documentation</a>)</li>
            </ul>
