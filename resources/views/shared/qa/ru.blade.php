        ...
        <div id="qa">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>В приложении для рабочего стола обновлены библиотеки hunspell до версии 1.7. Эти библиотеки существуют только в 64-битном варианте. Новые библиотеки используются только для немецкого и французского языков, поэтому обработка французских и немецких текстов независимой версией может осуществляться только на 64-битной системе.</li>
