<div id="stage" class="start">
    ...
    <!--
    <?php if ($_SERVER['REQUEST_URI'] == "/" || (isset($_SERVER['HTTP_ACCEPT_LANGUAGE']) && strpos($_SERVER['HTTP_ACCEPT_LANGUAGE'], "de") !== false) || $checkDefaultLang == "de") { ?>
    <div style="margin: 0 auto; text-align:center; font-size: 16px">
        <div style="width: 360px; background-color: white; margin: 0 auto; text-align:center; border-radius: 4px; padding: 5px">
            <a style="text-align:middle;color:black" class="ff-chrome jump_menu" href="/job/sea">
                Job: Online Marketing und SEA-Manager (m/w/d)
            </a>
        </div>
    </div>
    <?php } ?>
                    ...
                    <div class="editorHeader">
                        ...
                        <div class="editorHeaderRight">
                            ...
                            <?php } else if (isset($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'], "OPR/") !== false && strpos($_SERVER['HTTP_USER_AGENT'], "Android") === false) { ?>
                                <a class="ff-chrome opera jump_menu" type="button" href="https://addons.opera.com/extensions/details/grammar-and-spell-checker-languagetool/" target="_blank">
