...
@section('title', 'Job: Java-Entwickler (m/w/d)')
...
@section('content')
    <div id="textContent" class="content-section" style="text-align: left">
        ...
        <div class="container">
            ...
            <p style="text-align: right">Datum: 05.08.2020</p>
            ...
            <h2 style="text-align: center">Java-Entwickler (m/w/d),<br>32-40 h/Woche</h2>

            <p><b>Deine Aufgaben</b></p>
            
            <p>Du arbeitest daran, LanguageTool zu verbessern und zu erweitern:</p>
            ...
            <ul>
                ...
                <li>Du arbeitest eng mit dem Linguistik-Team zusammen, um deren neue Erweiterungen sicher und performant in Betrieb zu nehmen</li>
                <li>Du arbeitest eng mit dem DevOps-Team zusammen, um Monitoring und Performance unserer Server zu verbessern</li>
            </ul>
            ...
            <ul>
                ...
                <li>Sehr gute Programmierkenntnisse in Java</li>
            ...
            <p>Interesse? Sende Deine Fragen oder direkt Deine Bewerbung per
                <script type="text/javascript">
                    ...
                    document.write("<a href='mail" + "to:" + firstPart + "@" + lastPart + "?subject=Java-Entwickler (m/w/d)'>E-Mail an Daniel Naber<" + "/a>");
                    // -->
