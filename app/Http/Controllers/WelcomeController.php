...
class WelcomeController extends Controller
{
    ...
    {
        /*
         * NOTE! If you make changes here, also change XXXTest.java (XXX = the affected language) in the 'languagetool' repo:
         */
        ...
        $map['ru'] = "Вставьте ваш текст сюда .. или проверьте этот текстт. LanguageTool сможет найти грамматические и стилистические ошибки, которые не находят стандартные средства проверки орфографии. Релиз LanguageTool 5.1.3 состоялся в пятницу 15 октября 2020 года.";
        ...
        $map['nl'] = "Languagetool doet van zelfsprekend veel meer dan spellingcontrole. Het ziet ook fouten die minder inde gaten lopen, die je zelf geen eens ziet. De meldingen komen uit regels die door vrijwilligers gemaakt zijn aan de hand van suggesties van gebruikers en tips van taaldeskundigen. Ondanks het feit dat er veel aandacht aan de regels wordt besteed, blijven suggesties altijd welkom op het forum of op Twitter: @languagetool_nl. Probeer het rustig zelf eens uit hier, of download een van de plugins op deze pagina.";
