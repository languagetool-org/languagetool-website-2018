...
class WelcomeController extends Controller
{
    ...
    {
        /*
         * NOTE! If you make changes here, also change XXXDemoTextTest.java (XXX = the affected language) in the 'languagetool' repo:
         */
        ...
        $map['ru'] = "Вставьте ваш текст сюда .. или проверьте этот текстт. Релиз LanguageTool 4.7 состоялся в четверг 28 сентября 2019 года.";
