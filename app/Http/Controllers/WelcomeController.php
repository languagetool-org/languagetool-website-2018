...
class WelcomeController extends Controller
{
    ...
    private function getDefaultDemoTexts()
    {
        ...
        $map['fr'] = "LanguageTool offre une vérification orthographique et grammaticale. Il vous suffit de coller votre texte ici et de cliquer sur le bouton \"Vérifier le texte\". Cliqez sur les phrases en couleurs pour plus de détails sur les erreurs potentiels, ou utilisez ce texte pour voir quelques-uns des problèmes que LanguageTool Plus peut détecter. Que pensez vous des correcteurs grammaticaux ? Non pas qu'ils soient parfaits bien sur. Il est 17h de l'après-midi. Il faisait beau le jeudi 27 juin 2017.";
