...
AtDCore.prototype.markMyWords = function() {
    ...
    for (var suggestionIndex = this.suggestions.length-1; suggestionIndex >= 0; suggestionIndex--) {
        ...
        if (!suggestion.used) {
            ...
            } else if (/*suggestion.its20type === 'misspelling' ||*/ suggestion.typeName === "UnknownWord" || ruleId.indexOf("SPELLER_RULE") >= 0 || ruleId.indexOf("MORFOLOGIK_RULE") == 0 || ruleId == "HUNSPELL_NO_SUGGEST_RULE" || ruleId == "HUNSPELL_RULE" || ruleId == "FR_SPELLING_RULE") {
